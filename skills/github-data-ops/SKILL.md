...
### links 字段（相关资源链接）
用于为项目附上教程、测评、文档、视频等优质外部资源，帮助用户快速上手或深入了解。
...
- **必须包含至少 2-3 条非官方链接**（非官网、非官方文档），来自中文社区
...
### describe 字段
详情页展示，必须为中文。按以下顺序拼接内容：

**第一段（社区洞察，如能获取）**：
主动搜索 Reddit、Hacker News、V2EX 等社区中关于该项目的讨论，提炼社区真实声音，格式参考：

> 在 r/selfhosted 社区，该工具被讨论最多的三个标签是 #内存屠夫、#极简安装、#Notion平替。大部分老用户（v2.0 之前）认为它的新版虽然 UI 好看了，但失去了原本的轻量化优势。
