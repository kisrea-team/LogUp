    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row">
                {/* 桌面端侧边栏 */}
                <aside className="hidden md:block w-full md:w-64 bg-gray-50 min-h-screen border-r border-gray-200">
                    <div className="p-4">
                ...
                <main className="flex-1 p-4 md:p-8">
                    ...
                    >
                        <div className="bg-white border border-gray-200 rounded-lg p-6 dark:bg-card dark:border-border">
                            ...
                            {selectedProject.describe && (
                                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                                    ...
                                    <p className="text-gray-700 dark:text-gray-300">{selectedProject.describe}</p>
                                </div>
                            )}
                        </div>
                    </motion.div>
                    ...
                    {selectedVersion && (
                        ...
                        >
                            ...
                            {/* 更新内容 */}
                            <motion.div
                                className="bg-white border border-gray-200 rounded-lg p-6 mb-6 dark:bg-card dark:border-border"
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                                ...
                                <div className="prose prose-sm max-w-none dark:prose-invert">
                                    <ReactMarkdown
                                        components={{
                                            ...
                                            p: ({ node, ...props }) => (
                                                <p className="text-gray-700 mb-3 dark:text-gray-300" {...props} />
                                            ),
                                            ul: ({ node, ...props }) => (
